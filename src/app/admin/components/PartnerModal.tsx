...
export default function PartnerModal({ isOpen, onClose, partner }: PartnerModalProps) {
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-3xl max-h-[85vh] animate-fadeIn overflow-y-auto rounded-t-3xl border border-slate-200 bg-white shadow-[0_28px_80px_-55px_rgba(12,31,42,0.65)] sm:max-h-[90vh] sm:rounded-3xl"
